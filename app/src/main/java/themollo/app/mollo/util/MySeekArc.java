...
public class MySeekArc extends View {

    private static final String TAG = MySeekArc.class.getSimpleName();
    ...
    /**
     * The Maximum value that this MySeekArccan be set to
     */
    private int mMax = 100;

    /**
     * The Current value that the MySeekArcis set to
     */
    ...
    /**
     * The Width of the background arc for the MySeekArc
     */
    ...
    /**
     * Give the MySeekArcrounded edges
     */
    ...
    public interface OnSeekArcChangeListener {
        void onProgressChanged(MySeekArc mySeekArc, int progress, boolean fromUser);
        void onStartTrackingTouch(MySeekArc mySeekArc);
        void onStopTrackingTouch(MySeekArc mySeekArc);
    }

    public MySeekArc(Context context) {
        super(context);
        init(context, null, 0);
    }

    public MySeekArc(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, R.attr.seekArcStyle);
    }

    public MySeekArc(Context context, AttributeSet attrs, int defStyle) {
